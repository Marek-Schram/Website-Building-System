...
Chatbot: free rule-based FAQ widget (no cost) with optional Cloudflare Workers AI upgrade (free 10k neurons/day). Prospect brief: chains opportunities+audit+demo into one emailable HTML/PDF. See docs/CHATBOT.md, docs/PROSPECT-BRIEF.md.
